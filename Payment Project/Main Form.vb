...
Public Class frmMain
    ...
    Private Sub btnCalc_Click(sender As Object, e As EventArgs) Handles btnCalc.Click, cboRates.TextChanged
    ...
    Private Sub lstRates_SelectedIndexChanged(sender As Object, e As EventArgs)
        lblPay.Text = String.Empty
    End Sub
End Class
